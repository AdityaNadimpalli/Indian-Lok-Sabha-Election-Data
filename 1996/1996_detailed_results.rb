...
pdf_file_path = "1996_detailed_results.pdf"
outfilename = "1996_detailed_results_raw_output.csv"

out = open(outfilename, 'w')

extractor = Tabula::Extraction::ObjectExtractor.new(pdf_file_path, 1..313)
extractor.extract.each_with_index do |pdf_page, page_index|
  page_areas = [[85, 0, 770, 1700]]
  page_areas = [[85, 0, 760, 1700]]
