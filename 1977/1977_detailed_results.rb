...
pdf_file_path = "1977_detailed_results.pdf"
outfilename = "1977_detailed_results_raw_output.csv"

out = open(outfilename, 'w')

extractor = Tabula::Extraction::ObjectExtractor.new(pdf_file_path, 1..82)
extractor.extract.each_with_index do |pdf_page, page_index|
  ...
  vertical_ruling_locations = [0,930,1500] #column locations
