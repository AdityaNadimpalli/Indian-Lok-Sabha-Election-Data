...
pdf_file_path = "1999_constituency_summary.pdf"
outfilename = "1999_constituency_summary_raw_data.csv"
...
extractor.extract.each_with_index do |pdf_page, page_index|
  ...
  vertical_ruling_locations = [0,770,930,1250,1500] #column locations
