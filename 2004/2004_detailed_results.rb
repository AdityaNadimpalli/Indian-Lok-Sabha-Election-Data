...
pdf_file_path = "2004_1.pdf"
outfilename = "2004_raw_output_1.csv"

out = open(outfilename, 'w')

extractor = Tabula::Extraction::ObjectExtractor.new(pdf_file_path, 193..362)
extractor.extract.each_with_index do |pdf_page, page_index|
  page_areas = [[100, 0, 750, 1700]]

  scale_factor = pdf_page.width / 1700 
  # where 1700 is the width of the page as you measured it.

  vertical_ruling_locations = [0, 670, 850,1200, 1418, 1500] #column locations
