...
pdf_file_path = "1992_constituency_summary.pdf"
outfilename = "1992_constituency_summary_raw_data.csv"

out = open(outfilename, 'w')

extractor = Tabula::Extraction::ObjectExtractor.new(pdf_file_path, 1..13)
