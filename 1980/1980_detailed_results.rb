...
pdf_file_path = "1980_detailed_results.pdf"
outfilename = "1980_detailed_results_raw_output.csv"

out = open(outfilename, 'w')

extractor = Tabula::Extraction::ObjectExtractor.new(pdf_file_path, 1..126)
