...
pdf_file_path = "1984_constituency_summary.pdf"
outfilename = "1984_constituency_summary_raw_data.csv"

out = open(outfilename, 'w')

extractor = Tabula::Extraction::ObjectExtractor.new(pdf_file_path, 1..514)
