...
pdf_file_path = "1971_detailed_result.pdf"
outfilename = "1971_detailed_results_raw_output.csv"

out = open(outfilename, 'w')

extractor = Tabula::Extraction::ObjectExtractor.new(pdf_file_path, 1..95)
extractor.extract.each_with_index do |pdf_page, page_index|
  ...
  vertical_ruling_locations = [0,850,1400] #column locations
