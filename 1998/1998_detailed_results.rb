...
pdf_file_path = "1998_detailed_results.pdf"
outfilename = "1998_detailed_results_raw_output.csv"

out = open(outfilename, 'w')

extractor = Tabula::Extraction::ObjectExtractor.new(pdf_file_path, 1..100)
extractor.extract.each_with_index do |pdf_page, page_index|
  page_areas = [[85, 0, 940, 1700]]

  scale_factor = pdf_page.width / 1700 
  # where 1700 is the width of the page as you measured it.

  vertical_ruling_locations = [0,930,1250,1500] #column locations
